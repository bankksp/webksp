              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <FileUpload 
                    ...
                    onUploadSuccess={(url) => setConfig({...config, heroImageUrl: url})}
                  />
                  <div className="mt-2">
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
          <div className="p-8 border-b border-gray-50 bg-gray-50/50 flex items-center justify-between">
            ...
            <button 
              type="button"
              onClick={() => {
                const newSlides = [...(config.bannerSlides || [])];
                newSlides.push({
          ...
          <div className="p-8 space-y-6">
            <div className="grid grid-cols-1 gap-6">
              {[...(config.bannerSlides || [])].sort((a, b) => a.order - b.order).map((slide, idx) => (
                  ...
                  <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button 
                      ...
                      onClick={() => {
                        ...
                        newSlides[idx].order = newSlides[idx-1].order;
                        newSlides[idx-1].order = temp;
                        setConfig({...config, bannerSlides: newSlides});
                      }}
                    ...
                    <button 
                      type="button"
                      onClick={() => {
                        if (idx === (config.bannerSlides?.length || 0) - 1) return;
                        const newSlides = [...(config.bannerSlides || [])];
                        const temp = newSlides[idx].order;
                        newSlides[idx].order = newSlides[idx+1].order;
                        newSlides[idx+1].order = temp;
                    ...
                    <button 
                      type="button"
                      onClick={() => {
                        const newSlides = (config.bannerSlides || []).filter(s => s.id !== slide.id);
                        setConfig({...config, bannerSlides: newSlides});
                      }}
                        ...
                        <div className="space-y-1">
                          ...
                          <input 
                            ...
                            onChange={(e) => {
                              const newSlides = [...(config.bannerSlides || [])];
                              const sIdx = newSlides.findIndex(s => s.id === slide.id);
                              newSlides[sIdx].link = e.target.value;
                              setConfig({...config, bannerSlides: newSlides});
                            }}
                            className="w-full px-4 py-2 bg-white border-none rounded-xl focus:ring-2 focus:ring-blue-500 text-sm"
                          />
              ...
              {(!config.bannerSlides || config.bannerSlides.length === 0) && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <FileUpload 
                    ...
                    onUploadSuccess={(url) => setConfig({...config, announcementImageUrl: url})}
                  />
                </div>
                <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <FileUpload 
                  ...
                  onUploadSuccess={(url) => setConfig({...config, quickInfoImageUrl: url})}
                />
              </div>
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        onChange={(e) => {
                          const newPrograms = [...(config.recommendedPrograms || [])];
                          newPrograms[idx].link = e.target.value;
                          setConfig({...config, recommendedPrograms: newPrograms});
                        }}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-4">
                      <input 
                        ...
                        onChange={(e) => {
                          const newPrograms = [...(config.recommendedPrograms || [])];
                          newPrograms[idx].imageUrl = e.target.value;
                          setConfig({...config, recommendedPrograms: newPrograms});
                        }}
              ...
              <button 
                type="button"
                onClick={() => {
                  const newPrograms = [...(config.recommendedPrograms || []), { title: '', imageUrl: '', link: '' }];
                  setConfig({...config, recommendedPrograms: newPrograms});
                }}
...
export default HomeEditorClient;
