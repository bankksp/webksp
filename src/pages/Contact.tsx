...
import { getSchoolInfo, sendContactMessage } from '../services/dataService';
...
export const Contact = () => {
  ...
  return (
    <div className="pt-20 bg-gray-50 min-h-screen">
      <Helmet>
        <title>ติดต่อเรา | โรงเรียนกาฬสินธุ์ปัญญานุกูล จังหวัดกาฬสินธุ์</title>
        <meta name="description" content="หากคุณมีข้อสงสัยหรือต้องการข้อมูลเพิ่มเติม สามารถติดต่อโรงเรียนกาฬสินธุ์ปัญญานุกูลได้ผ่านช่องทางต่างๆ หรือส่งข้อความหาเรา" />
        <meta property="og:title" content="ติดต่อเรา | โรงเรียนกาฬสินธุ์ปัญญานุกูล" />
        <meta property="og:description" content="หากคุณมีข้อสงสัยหรือต้องการข้อมูลเพิ่มเติม สามารถติดต่อโรงเรียนกาฬสินธุ์ปัญญานุกูลได้ผ่านช่องทางต่างๆ หรือส่งข้อความหาเรา" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <select 
                        ...
                        className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all font-medium appearance-none"
                      >
