import { fetchFromGAS } from '../_shared/gas';
import { getGasConfig, type CloudflareEnv } from '../_shared/env';

async function handleDataRequest(request: Request, env: CloudflareEnv): Promise<Response> {
